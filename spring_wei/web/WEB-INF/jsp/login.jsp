...
<div class="container">
    ...
    <div class="container__form container--signin">
        <form action="${pageContext.request.contextPath}/book/authenticate" method="post" class="form">
            ...
            <a href="${pageContext.request.contextPath}/book/toresign" class="btn">注册</a>
        </form>
